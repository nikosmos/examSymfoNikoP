...
{
    #[Route('/index', name: 'app_brand_index', methods: ['GET'])]
    public function index(BrandRepository $brandRepository): Response
    {
        return $this->render('back/pages/brand/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('back/pages/brand/new.html.twig', [
            'brand' => $brand,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/pages/brand/show.html.twig', [
            'brand' => $brand,
        ]);
    }
    ...
    public function edit(Request $request, Brand $brand, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('back/pages/brand/edit.html.twig', [
            'brand' => $brand,
            'form' => $form,
        ]);
    }
